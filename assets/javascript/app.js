$(document).ready(function () {
    ...
    function populateIntro() {
        ...
        var introContent = $("<p id='intro-text'>I'm <span class='blue-text'>Sheetal</span>.<br><span class='blue-text'>Full stack web developer with Automation development and QA background</span>. <br>Currently seeking Full Stack Development roles</p>");
