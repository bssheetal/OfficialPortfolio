$(document).ready(function () {
    ...
    function populateIntro() {
        ...
        var introContent = $("<p id='intro-text'>I'm <span class='blue-text'>Sheetal</span>.<br><span class='blue-text'>A new·bie full stack web developer and Automation Engineer over a span of 8 years</span>. <br>Currently exploring Back-End Techniques</p>");
    ...
    function populatePortfolio() {
        ...
        var projcard1 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'><img src='assets/images/Hive.PNG'><span style='font-size:1.40em;' class='card-title white-text blue'>The Hive</span></div><div class='card-content'><p class='card-textcontent'>A social application which connects new residents to local activities & professional opportunities built using jquery,Firebase,HTML5 & CSS </p></div><a style='font-size:1.40em;padding:10px;' class='blue-text' href='https://sababorj.github.io/project-1-DT/index.html' target='_blank'>View Project</a><p style='font-size:1.40em;margin-top: 15px; margin-bottom: 5px;'><a class='black-text' href='https://github.com/sababorj/project-1-DT' target='_blank'>GitHub</a></p></div></div>");
